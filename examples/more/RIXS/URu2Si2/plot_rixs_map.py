...
plt.imshow(spectra_pi_pol,    extent=[min(omega),max(omega), min(eloss), max(eloss)], origin='lower', aspect='auto',cmap='jet', interpolation='bicubic')
...
plt.imshow(spectra_sigma_pol, extent=[min(omega),max(omega), min(eloss), max(eloss)], origin='lower', aspect='auto',cmap='jet', interpolation='bicubic')
plt.xlabel(r'Energy of incident photon (eV)')
