...
plt.imshow(spectra_pi_pol,    extent=[min(omega)/1000,max(omega)/1000, min(eloss), max(eloss)], origin='lower', aspect='auto',cmap='cubehelix', interpolation='bicubic')
...
plt.text(10.873, 1.8, r"$\pi$-pol", color="white", fontsize=30)

ax2=plt.subplot(1,2,2)
plt.imshow(spectra_sigma_pol, extent=[min(omega)/1000,max(omega)/1000, min(eloss), max(eloss)], origin='lower', aspect='auto',cmap='cubehelix', interpolation='bicubic')
...
plt.text(10.873, 1.8, r"$\sigma$-pol", color="white", fontsize=30)
