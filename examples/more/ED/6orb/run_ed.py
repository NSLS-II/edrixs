...
def do_ed():
    ...
    # Exact-diagonalization of total H to get the eigenvalues and eigenvectors
    # eigenval: 1d float array with the order of increasing energy
    # eigenvec: 2d complex array, eigenvec[:,k] is the eigenvectors for k-th eigenvalue
    # case 1: without SOC
    H = H_U + H_zeeman
