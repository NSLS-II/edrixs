...
Hamiltonian, which is a simplified  form for the interactions, which treats all orbitals as
...
def diagonalize(U, JH, t, eL, n=1):
    ...
    emat[ind+norb//2, ind] = np.conj(t)  # conj is not needed, but is good practice.
...
plt.show()
################################################################################
# Around :math:`e_L = 10` we see that the exciton is a
