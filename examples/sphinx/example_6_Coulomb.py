...
# :math:`U_{\alpha\sigma,\beta\sigma^\prime,\gamma^\prime,\delta\sigma}`.
...
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`xz, x^2-y^2`          | :math:`A-2B+C`  | :math:`F_0+2F_2-4F_4` |:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`xz, xy`               | :math:`A-2B+C`  | :math:`F_0+2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`yz, x^2-y^2`          | :math:`A-2B+C`  | :math:`F_0+2F_2-4F_4` |:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
...
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, yz, x^2-y^2, xz`          | :math:`-\sqrt{3}B`                                 | :math:`-\sqrt{3}F_2+5\sqrt{3}F_4`                   |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
