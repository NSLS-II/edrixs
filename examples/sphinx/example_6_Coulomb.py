...
# :math:`U_{\alpha\sigma,\alpha\bar\sigma,\beta\bar\sigma,\beta\sigma}`
...
# 5. Three orbital
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Another set of terms that one might not immmediately anticipate involve three
# orbitals,
...
B = F2/49 - 5*F4/441 
for val in [np.sqrt(3)*B, 2*np.sqrt(3)*B, 3*B]:
    umat_no_multiorbital[(np.abs(umat)- val/2) < 1e-6] = 0
...
#    +=============================+=================+=======================+===============+==================+
#    |:math:`3z^2-r^2, xz`         | :math:`A+2B+C`  | :math:`F_0+2F_2-24F_4`| :math:`B+C`   | :math:`F_2+30F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`3z^2-r^2, yz`         | :math:`A+2B+C`  | :math:`F_0+2F_2-24F_4`| :math:`B+C`   | :math:`F_2+30F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`3z^2-r^2, x^2-y^2`    | :math:`A-4B+C`  | :math:`F_0-4F_2+6F_4` |:math:`4B+C`   |:math:`4F_2+15F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`3z^2-r^2, xy`         | :math:`A-4B+C`  | :math:`F_0-4F_2+6F_4` |:math:`4B+C`   |:math:`4F_2+15F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`xz, yz`               | :math:`A-2B+C`  | :math:`F_0-2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`xz, x^2-y^2`          | :math:`A-2B+C`  | :math:`F_0-2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`xz, xy`               | :math:`A-2B+C`  | :math:`F_0-2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`yz, x^2-y^2`          | :math:`A-2B+C`  | :math:`F_0-2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`yz, xy`               | :math:`A-2B+C`  | :math:`F_0-2F_2-24F_4`|:math:`3B+C`   |:math:`3F_2+20F_4`|
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
#    |:math:`x^2-y^2, xy`          | :math:`A+4B+C`  | :math:`F_0+4F_2-34F_4`| :math:`C`     | :math:`35F_4`    |
#    +-----------------------------+-----------------+-----------------------+---------------+------------------+
# 
# 
# .. _table_3_orbital:
...
#    +=============================+=============+====================================================+=====================================================+
#    |:math:`3z^2-r^2, xz, x^2-y^2, xz`          | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, yz, x^2-y^2, yz`          | :math:`-\sqrt{3}B`                                 | :math:`-\sqrt{3}F_2+5\sqrt{3}F_4`                   |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`xz, 3z^2-r^2, x^2-y^2, xz`          | :math:`-2\sqrt{3}B`                                | :math:`-2\sqrt{3}F_2+10\sqrt{3}F_4`                 |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`xz, xz, x^2-y^2, 3z^2-r^2`          | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`yz, 3z^2-r^2, x^2-y^2, yz`          | :math:`2\sqrt{3}B`                                 | :math:`2\sqrt{3}F_2-10\sqrt{3}F_4`                  |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`xz, xz, x^2-y^2, 3z^2-r^2`          | :math:`-\sqrt{3}B`                                 | :math:`-\sqrt{3}F_2+5\sqrt{3}F_4`                   |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
# 
...
#    |Orbitals :math:`\alpha,\beta,\gamma,\delta`|:math:`\langle\alpha\beta|\gamma\delta\rangle` Racah|:math:`\langle\alpha\beta|\gamma\delta\rangle` Slater|
#    +=============================+=============+====================================================+=====================================================+
#    |:math:`3z^2-r^2, xz, yz, xy`               | :math:`-2\sqrt{3}B`                                | :math:`-2\sqrt{3}F_2+10\sqrt{3}F_4`                 |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, xz, xy, yz`               | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, yz, xz, xy`               | :math:`-2\sqrt{3}B`                                | :math:`-2\sqrt{3}F_2+10\sqrt{3}F_4`                 |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, yz, xy, xz`               | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, xy, xz, yz`               | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`3z^2-r^2, xy, yz, xz`               | :math:`\sqrt{3}B`                                  | :math:`\sqrt{3}F_2-5\sqrt{3}F_4`                    |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`x^2-y^2 , xz, xy, yz`               | :math:`-3B`                                        | :math:`-3F_2+15F_4`                                 |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`x^2-y^2 , yz, xy, xz`               | :math:`3B`                                         | :math:`3F_2-15F_4`                                  |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`x^2-y^2 , xy, xz, yz`               | :math:`-3B`                                        | :math:`-3F_2+15F_4`                                 |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
#    |:math:`x^2-y^2 , xy, yz, xz`               | :math:`3B`                                         | :math:`3F_2-15F_4`                                  |
#    +-------------------------------------------+----------------------------------------------------+-----------------------------------------------------+
# 
# 
# .. rubric:: Footnotes
